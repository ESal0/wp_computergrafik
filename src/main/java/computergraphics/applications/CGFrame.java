...
public class CGFrame extends AbstractCGFrame {
    ...
    private void exercise6() {
        ...
        shaderNode.addChild(new SphereNode(0.6, 20, new Vector3(-0.5, 0.7, -1.6), new Vector3(0.9, 0.2, 0.1)));
        ...
        this.getRoot().addLightSource(new LightSource(new Vector3(0, 8, 0), new Vector3(1, 0, 0)));
        new ImageViewer(raytracer.render(1200, 800));
